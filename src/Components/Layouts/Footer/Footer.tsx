        ...
        <footer className={styles.footer}>
            <section className={styles.footerContent}>
                ...
                <div className={styles.footerSocial}>
                    ...
                    <img src={`${import.meta.env.BASE_URL}icons/linkedin-in-white.png`} alt="LinkedIn" className={styles.socialIcon} />
                    <img src={`${import.meta.env.BASE_URL}icons/itchio-white.svg`} alt="itch.io" className={styles.socialIcon} />
                    <img src={`${import.meta.env.BASE_URL}icons/github-white.svg`} alt="GitHub" className={styles.socialIcon} />
                    <img src={`${import.meta.env.BASE_URL}icons/discord-white.svg`} alt="Discord" className={styles.socialIcon} />
                </div>
            </section>
        </footer>
    )
